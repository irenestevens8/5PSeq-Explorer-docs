...
```bash
docker pull stevensirene/fivepseq-explorer:v1.7
docker run -d -p 3838:3838 stevensirene/fivepseq-explorer:v1.7
```

For Mac, please use flag ‘--platform=linux/amd64’
```bash
docker run --platform=linux/amd64 -d -p 3838:3838 stevensirene/fivepseq-explorer:v1.7 
```
